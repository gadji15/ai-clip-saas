          ...
          <CardContent>
            <div className="flex flex-wrap items-end justify-between gap-4">
              <div>
                ...
                <div className="mt-1 text-sm text-slate-500">{t('plan.priceHint')}</div>
              </div>
            ...
            <div className="mt-5 rounded-lg border border-slate-200 bg-slate-50 p-4">
              <div className="flex items-center justify-between gap-3">
                <div className="text-sm font-medium text-slate-800">{t('usage.title')}</div>
              ...
              <div className="mt-3">
                ...
                <div className="mt-2 text-xs text-slate-500">{t('usage.hint')}</div>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="rounded-lg border border-slate-200 bg-white p-3">
                <div className="text-xs font-medium text-slate-500">{t('payment.methodLabel')}</div>
                <div className="mt-1 text-sm font-medium text-slate-800">Visa •••• 4242</div>
              </div>
              <div className="rounded-lg border border-slate-200 bg-white p-3">
                <div className="text-xs font-medium text-slate-500">{t('payment.billingEmailLabel')}</div>
                <div className="mt-1 text-sm text-slate-700">billing@youtok.com</div>
              </div>
            </div>
          </CardContent>
          <CardFooter>
      ...
      <Card className="mt-6">
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <div className="grid grid-cols-3 items-center gap-3 rounded-lg border border-slate-200 bg-white p-3">
